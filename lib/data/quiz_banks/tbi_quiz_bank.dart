...
class TBIQuizBank {
  static const List<QuizQuestion> _handwritten = [
    ...
    QuizQuestion(
      ...
      correctIndex: 2,
      explanation: 'The BTF 4th Edition changed the ICP treatment threshold from 20 to 22 mmHg. "22 is the new 20." Normal adult ICP is 5-15 mmHg (supine).',
      moduleId: 'tbi-fundamentals',
      difficulty: 'board',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      question: 'What are the FDA-cleared cutoff values for the Banyan Brain Trauma Indicator (GFAP and UCH-L1) used to rule out CT-positive findings in mild TBI?',
      options: [
        'GFAP <100 pg/mL, UCH-L1 <500 pg/mL',
        'GFAP <22 pg/mL, UCH-L1 <327 pg/mL',
        'GFAP <50 ng/mL, UCH-L1 <100 ng/mL',
        'GFAP <10 pg/mL, UCH-L1 <50 pg/mL',
      ],
      correctIndex: 1,
      explanation: 'The Banyan BTI (FDA-cleared 2018, validated by ALERT-TBI; Bazarian et al., Lancet Neurol 2018) uses cutoffs of GFAP <22 pg/mL AND UCH-L1 <327 pg/mL — both must be below threshold for a negative result. Sensitivity 97.6%, NPV 99.6% for CT-positive intracranial lesions in adults with GCS 13-15 within 12 hours of injury. The Abbott i-STAT TBI Plasma cartridge (FDA-cleared 2021) and i-STAT TBI Whole Blood (2023) deliver bedside results in ~15 minutes using the same cutoffs.',
      moduleId: 'acute-management',
      difficulty: 'board',
    ),
    QuizQuestion(
    ...
    QuizQuestion(
      ...
      correctIndex: 2,
      explanation: 'The Cochrane review found beta-blockers (propranolol, pindolol) have the best evidence for efficacy in treating posttraumatic agitation. Typical TBI dosing is 20-60 mg TID-QID (60-240 mg/day); the Brooke 1992 RCT titrated up to 420 mg/day. Monitor for hypotension and bradycardia (hold if HR < 60 or SBP < 90).',
