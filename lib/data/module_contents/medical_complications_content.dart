    ...
    TopicTab(
      ...
      blocks: [
        ...
        BulletCardBlock(
          ...
          points: [
            'Design: Prospective observational study at 2 Level I trauma centers over 33 months',
            'Population: 1,191 screened; 813 analyzed (blunt TBI requiring seizure prophylaxis)',
            'Groups: Levetiracetam (n=406) vs phenytoin (n=407)',
            'Primary outcome: No significant difference in early PTS incidence (LEV 1.5% vs PHT 1.5%, p=0.997)',
            'Adverse drug reactions and mortality: No significant difference between groups',
        ...
        BulletCardBlock(
          ...
          points: [
            ...
            'Neurocritical Care Society (2024 Guidelines for Seizure Prophylaxis in Mod-Severe TBI): After systematic review, the panel made NO recommendation FOR or AGAINST routine antiseizure medication (ASM) prophylaxis and made NO recommendation for a specific ASM, citing very low to low certainty evidence. Practice varies; the historic 7-day window from Temkin (1990) remains common, but the 2024 NCS document explicitly does not endorse it. Prophylaxis in mild/moderate TBI yields a very small absolute risk reduction (~0.6%).',
          ],
        ),
